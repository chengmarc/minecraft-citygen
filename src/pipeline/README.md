...
`artifacts/05_world/saves/Minecraft CityGen World <n>/` (via
...
artifacts/05_world/saves/Minecraft CityGen World <n>/       # standalone playable world
```

The final city schematic in `artifacts/04_city/schem/` is a Sponge `.schem`;
`artifacts/05_world/saves/Minecraft CityGen World <n>/` is a copied source-world save with generated
